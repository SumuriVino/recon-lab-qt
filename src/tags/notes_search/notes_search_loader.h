#ifndef NOTES_SEARCH_LOADER_H
#define NOTES_SEARCH_LOADER_H
...
class notes_search_loader : public table_result_loader
{
public:
    notes_search_loader(QWidget *parent = 0);
    ~notes_search_loader();

    void pub_notes_search_set_display_db_path(QString db_path);
    void notes_search_populate_data_in_table();
...
private:
    QString destination_db_path_for_note_search;
