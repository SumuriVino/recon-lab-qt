#ifndef APPLE_METADATA_FILTERS_H
#define APPLE_METADATA_FILTERS_H
...
class apple_metadata_filters : public QWidget
{
    Q_OBJECT
public:
    explicit apple_metadata_filters(QWidget *parent = nullptr);

    void pub_create_ui();
    void pub_set_essentials();
    QString pub_collect_all_spotlight_search_filters_information();
    void pub_set_all_filter_status(bool staus);
...
private:
    ...
    enum enum_file_systemem_Widget_Type
    {
        ...
        enum_File_System_Widget_Type_FILESYSTEM_REAL_VALUE      // 23.45
    };
    ...
    QString db_path_apple_attributes;

    void on_apl_attribute_ok_button_click();
    void on_apl_attribute_cancel_button_click();
    ...
    QStringList get_main_list_from_apl_attribute_database();
    ...
    QString get_mdkind_condition_str_for_widget_type_real_value(QStringList sub_name_list, QString colmn_name);

    bool bool_all_filter_status;
    QComboBox *combobox_search_type_filter;
