...
void spotlight_filters::slot_on_combobox_search_type_current_index_changed(int index)
{
    ...
    {
        recon_static_functions::app_debug(" destination_dbOpen -------FAILED------ " + db_path_case_confg, Q_FUNC_INFO);
    ...
    if(combobx_txt_wid->itemText(index) == MACRO_Generic_Filter_Condition_Others)
    {
        apple_attributes_obj->pub_set_page_caller(MACRO_CONFIGURATION_CALLER_TYPE_POST_LAUNCHER);
        apple_attributes_obj->set_essentials();
        apple_attributes_obj->show();

        connect(apple_attributes_obj,SIGNAL(signal_workdone_complete(bool)),this,SLOT(slot_apple_attributes_work_done(bool)));
        combobx_txt_wid->setCurrentIndex(last_save_index);
...
void spotlight_filters::slot_on_pushbutton_delete_clicked()
{
    recon_static_functions::app_debug(" Starts" , Q_FUNC_INFO);
...
void spotlight_filters::slot_on_pushbutton_add_clicked()
{
    recon_static_functions::app_debug(" Starts " , Q_FUNC_INFO);
...
void spotlight_filters::slot_apple_attributes_work_done(bool bool_ok_or_cancel)
{
    apple_attributes_obj->hide();

    if(bool_ok_or_cancel)
        on_appl_attribute_ok_button_click();
    else
        on_appl_attribute_cancel_button_click();
}

void spotlight_filters::slot_on_combobox_ext_attr_kind_current_index_changed(QString current_str)
{
...
void spotlight_filters::slot_on_combobox_ext_attr_dates_current_index_changed(QString current_str)
{
    recon_static_functions::app_debug(" Starts " , Q_FUNC_INFO);
