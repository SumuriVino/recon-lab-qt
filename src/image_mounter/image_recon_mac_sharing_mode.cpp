...
int image_mounter::mount_recon_mac_sharing_mode_images()
{
    ...
    {
        value = mount_recon_mac_sharing_mode_dmg_sparseimage();
    }
...
int image_mounter::mount_recon_mac_sharing_mode_dmg_sparseimage()
{
    recon_static_functions::app_debug(" start ",Q_FUNC_INFO);
