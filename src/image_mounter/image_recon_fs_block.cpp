...
int image_mounter::mount_recon_fs_block_images()
{
    ...
    {
        value = mount_recon_fs_block_sparseimages();
    }
...
int image_mounter::mount_recon_fs_block_sparseimages()
{
    recon_static_functions::app_debug(" start ",Q_FUNC_INFO);
    ...
    int value = mount_recon_fs_block_image_after_hdiutil(out_hdiutil);
...
int image_mounter::mount_recon_fs_block_image_after_hdiutil(QString out_hdiutil)
{
    recon_static_functions::app_debug(" start",Q_FUNC_INFO);
