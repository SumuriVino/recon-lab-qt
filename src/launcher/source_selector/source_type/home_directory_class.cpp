...
void Home_Directory_Class::pub_set_id_and_name(int id, QString name)
{
    received_id = id;
    received_name = name;
}

int Home_Directory_Class::pub_get_id()
{
    return received_id;
}

int Home_Directory_Class::pub_get_window_height()
{
    return this->minimumHeight();
}

void Home_Directory_Class::on_pushButton_add_username_clicked()
{
...
void Home_Directory_Class::on_pushButton_cancel_clicked()
{
    this->hide();
}
