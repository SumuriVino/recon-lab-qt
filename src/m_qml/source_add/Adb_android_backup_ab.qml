...
Rectangle
{
    ...
    Image
    {
        id: image_rectangle_mobile_ab_image
        x: 0
        y: 0
        ...
        TextField
        {
            id: textfield_mobile_ab_image_filepath
            x: 157
            y: 192
            width: 688
            height: 24
        ...
        Button
        {
            id: button_browse_mobile_ab_image
            x: 867
            y: 192
            width: 58
            height: 24
...
//            font.pointSize: 20
            ...
            onClicked:
            {
                let image_path = source_selector_obj.pbin_button_source_path_selection_clicked(source_selector_obj.pbin_get_label("RootType_ADBAndroidBackup"),source_selector_obj.pbin_get_label("SourceType_ADBAndroidBackup_AB_Internal"))
                if(image_path !== "")
                {
                    textfield_mobile_ab_image_filepath.clear()
                    textfield_mobile_ab_image_filepath.insert(0,image_path)
                }
            }
            background: Rectangle
            {
                id:rectangle_browse_mobile_ab_image
                radius:20
            }
        }
        Button
        {
            id: button_add_mobile_ab_image
            x: 427
            y: 233
            width: 148
            height: 24
...
//            text: source_selector_obj.pbin_get_label("Add")
            ...
            checkable: false
            checked: false
            enabled: textfield_mobile_ab_image_filepath.text ? true:false
            onClicked:
            {
                source_selector_obj.pbin_button_add_selected_sources(source_selector_obj.pbin_get_label("EvidenceType_Mobile"),source_selector_obj.pbin_get_label("RootType_ADBAndroidBackup"),source_selector_obj.pbin_get_label("SourceType_ADBAndroidBackup_AB_Display"),source_selector_obj.pbin_get_label("SourceType_ADBAndroidBackup_AB_Internal"),textfield_mobile_ab_image_filepath.text,"","","")
                setVisible(false)
            }
            background: Rectangle
            {
    ...
    Label
    {
        ...
        text: source_selector_obj.pbin_get_label("[")
              ...
              + source_selector_obj.pbin_get_label(">")
              + source_selector_obj.pbin_get_label("SourceType_ADBAndroidBackup_AB_Display")
              + source_selector_obj.pbin_get_label("]")
        font.pointSize: 15
        color: "#ffc600"
    }
