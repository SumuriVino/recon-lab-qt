...
/* This class has the front-end ui of selecting the forensics image of other operating system as a source by clicking on browse button and when we click on
