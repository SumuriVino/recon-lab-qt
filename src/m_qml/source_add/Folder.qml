...
/* This class has the front-end ui of selecting the folder as a source by clicking on browse button and when we click on add button it will send that path to c++
