...
/*This class has the front-end ui of selecting the Recon Logical folder as a source by clicking on browse button and when we click on add button
...
//            font.pointSize: 20
            ...
            onClicked:
            {
                let image_path = source_selector_obj.pbin_button_source_path_selection_clicked(source_selector_obj.pbin_get_label("RootType_RECONLogicalImage"),source_selector_obj.pbin_get_label("SourceType_RECONLogicalImage_Folder_Internal"))
                if(image_path !== "")
                {
...
//            text: source_selector_obj.pbin_get_label("Add")
            ...
            onClicked:
            {
                source_selector_obj.pbin_button_add_selected_sources(source_selector_obj.pbin_get_label("EvidenceType_Logical"),source_selector_obj.pbin_get_label("RootType_RECONLogicalImage"),source_selector_obj.pbin_get_label("SourceType_RECONLogicalImage_Folder_Display"),source_selector_obj.pbin_get_label("SourceType_RECONLogicalImage_Folder_Internal"),textfield_logical_folder_filepath.text,"","","")
                setVisible(false)
            }
            background: Rectangle
            {
