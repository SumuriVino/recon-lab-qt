...
/* This class has the front-end ui of selecting the forensics image of Windows operating system as a source by clicking on browse button and when we click on add button
...
//            text: source_selector_obj.pbin_get_label("Add")
    ...
    Label
    {
        ...
        text: source_selector_obj.pbin_get_label("[")
              ...
              + source_selector_obj.pbin_get_label(">")
              + source_selector_obj.pbin_get_label("OS_SCHEME_winOS_Display")
              + source_selector_obj.pbin_get_label("]")
        font.pointSize: 15
        color: "#ffc600"
    }
