#ifndef PLIST_VIEWER_REPORT_HTML_TEMPLATE_H
#define PLIST_VIEWER_REPORT_HTML_TEMPLATE_H
...
class plist_viewer_report_html_template
{
public:
    plist_viewer_report_html_template();
    ~plist_viewer_report_html_template();
...
#endif // PLIST_VIEWER_REPORT_HTML_TEMPLATE_H
