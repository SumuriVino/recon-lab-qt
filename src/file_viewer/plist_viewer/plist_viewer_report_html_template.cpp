...
plist_viewer_report_html_template::plist_viewer_report_html_template()
{
...
QString plist_viewer_report_html_template::html_title(QString title)
{
    return (QString("<title>") + title + "</title>");
}

QString plist_viewer_report_html_template::html_header_after_title()
{
...
QString plist_viewer_report_html_template::html_sidebar_start()
{
    QString sidebar_start = "<table width = \"100%\" border=\"0\" align=\"center\" cellpadding=\"1\" cellspacing=\"0\">  <tr>  <td> ";
    return sidebar_start;
}

QString plist_viewer_report_html_template::html_sidebar_link(QString module_name)
{
...
QString plist_viewer_report_html_template::html_report_main_title(QString icon, QString title_name)
{
...
QString plist_viewer_report_html_template::html_module_header(QString icon_path, QString report_content, QString module_name)
{
...
QString plist_viewer_report_html_template::html_sub_module_header(QString module_name)
{
    QString temp = "<br /><a name=\"";
    temp += module_name + "\"> </a>  <div> <h4 class=\"caption\" id=\"\"><span class=\" s14\" id=\"\">";
...
QString plist_viewer_report_html_template::html_top_link()
{
...
QString plist_viewer_report_html_template::html_top_module_header(QString module_name)
{
    QString temp = " <a href = \"#Top\">" + QObject::tr("Top") + "</a> </div>";
    return temp;

}
QString plist_viewer_report_html_template::html_table_start()
{
...
QString plist_viewer_report_html_template::html_table_headers(QStringList list, int value)
{
    ...
    {
        temp += "<th width=\"50\" >" + list.at(0) + "</th>";
        temp += "<th width=\"100%\" >" + list.at(1) + "</th>";
        temp += "<th width=\"60%\" >" + list.at(2) + "</th>";

        for(int i = 3; i < list.size(); i ++)
        {
            temp += "<th width=\"100%\" >" + list.at(i) + "</th>";
        }
...
QString plist_viewer_report_html_template::html_table_row_data(QStringList list, int value)
{
    QString temp;
    temp = "<tr>";
...
QString plist_viewer_report_html_template::html_table_end()
{
    return QString("</table>");
}


QString plist_viewer_report_html_template::html_sidebar_end()
{
