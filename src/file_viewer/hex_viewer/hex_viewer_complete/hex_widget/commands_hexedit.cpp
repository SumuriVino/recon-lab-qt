...
public:
    ...
    CharCommand(Chunks_hexedit * chunks, CCmd cmd, qint64 charPos, char newChar,
...
CharCommand::CharCommand(Chunks_hexedit * chunks, CCmd cmd, qint64 charPos, char newChar, QUndoCommand *parent)
    : QUndoCommand(parent)
{
    _chunks = chunks;
    _charPos = charPos;
...
UndoStack::UndoStack(Chunks_hexedit * chunks, QObject * parent)
    : QUndoStack(parent)
{
    _chunks = chunks;
    _parent = parent;
