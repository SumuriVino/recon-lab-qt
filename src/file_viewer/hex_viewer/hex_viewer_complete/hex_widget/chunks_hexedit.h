#ifndef CHUNKS_HEXEDIT_H
#define CHUNKS_HEXEDIT_H
...
class Chunks_hexedit: public QObject
{
Q_OBJECT
public:
    // Constructors and file settings
    Chunks_hexedit(QObject *parent);
    Chunks_hexedit(QIODevice &ioDevice, QObject *parent);
    ...
    void pub_set_source_file_path(QString path);
    void pub_set_source_size(qint64 source_size);
    void pub_set_source_block_size(int source_block_size);
...
private:
    ...
    qint64 _pos;
    qint64 _size;
    QList<Chunk_hexedit_struct> _chunks;
