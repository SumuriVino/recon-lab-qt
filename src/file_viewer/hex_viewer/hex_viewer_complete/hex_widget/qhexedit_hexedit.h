#ifndef QHEXEDIT_HEXEDIT_H
#define QHEXEDIT_HEXEDIT_H
...
restrictions.
*/
class QHEXEDIT_API QHexEdit_hexedit : public QAbstractScrollArea
{
    Q_OBJECT
...
public:
    ...
    */
    QHexEdit_hexedit(QWidget *parent=0);
    ...
    */
    ...
    void pub_set_tags_list_obj(QList<struct_hex_viewer_tag> *list);
...
signals:
    ...
    void signal_right_click();

    void signal_left_click();
...
public:
    ...
    qint64 pub_get_selection_start();
    qint64 pub_get_selection_end();

    void pub_set_jump_to_address(qint64 adr);

    qint64 pub_get_current_address();

    void pub_refresh_view();

    void pub_set_source_file(QString);
    void pub_set_source_size(qint64);
    void pub_set_source_block_size(int);

    void pub_set_hightlight_tags_list(QList<struct_hex_viewer_tag> list);

    QByteArray pub_get_selected_bytes();
    bool pub_is_data_available();
    void pub_set_64_bit_scroll_bar_obj(Scrollbar64 *);
protected:
    // Handle events
...
signals:
    void signal_selected_data_offsets(qint64 start_address, qint64 end_address);
    void signal_cursor_position(qint64 pos);
...
private slots:
    ...
    void slot_scroll_bar_64_changed(qint64 scrol_pos);
...
private:
    ...
    Chunks_hexedit *_chunks;                            // IODevice based access to data
    ...
    QList<struct_hex_viewer_tag> *tags_list;
    QList<struct_hex_viewer_tag> highlight_tags_list;

    bool highlight_block_bytes_fun(qint64 cur_char, QColor &col);

    QString sourse_file_path;
    qint64 source_file_size;
    qint64 source_block_size;
    bool bool_show_offsets_in_decimal;

    Scrollbar64 *scroll_bar_64_obj = NULL;

    bool bool_change_cursor_pos = false;
};

#endif // QHEXEDIT_HEXEDIT_H
